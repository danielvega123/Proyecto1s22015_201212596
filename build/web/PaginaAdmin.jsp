...
document.getElementById('datosbus').style.display='none';
...
if (document.tipousu.tipo[4].checked === true) {
//muestra (cambiando la propiedad display del estilo) el div con id 'desdeotro'
document.getElementById('datosadmin').style.display='none';
document.getElementById('datosestcla').style.display='none';
document.getElementById('datosestgen').style.display='none';
document.getElementById('datoschofer').style.display='none';
document.getElementById('datosbus').style.display ='block';
document.getElementById('datosruta').style.display ='none';
...
document.getElementById('datoschofer').style.display='none';
document.getElementById('datosbus').style.display ='none';
document.getElementById('datosruta').style.display ='block';
...
<li><input type="radio" name="tipo" id = "tipo_0" onclick=" mostrarllenardatos();" value="Admin">Administrador</li>
        ...
        <div action="PaginaAdmin.jsp" method="POST" id="datosruta" style="display:none;">
              <p>Ruta</p>
                ...
                <label>RutaInicio:<p><input type="text" name="txtrutainicio" class="input" /></label></p>
                <label>RutaFin:<p><input type="text" name="txtrutafin" class="input" /></label></p>
                <input type="submit" value="Aceptar" />
                <div style="clear:both">&nbsp;</div>
	</div>
