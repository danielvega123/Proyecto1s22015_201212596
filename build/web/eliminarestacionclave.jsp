...
<link href="default.css" rel="stylesheet" type="text/css" media="screen" />
	...
	<div id="header">
		...
		<div id="logo">
            ...
            <form action="eliminarestacionclave.jsp" method="POST">
	...
	java.util.List<java.lang.Object> result = port.imprimirListaestcla();
        int j = result.size();
        int i;
        %>
	...
	port.eliminarEstacionClave(id);
        out.println("se elimino correctamente el id" + id);
        
    } catch (Exception ex) {
	out.println("no sep pudo eliminar");
    }
    %>
