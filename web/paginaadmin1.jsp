<%-- 
    ...
    Created on : 12-sep-2015, 9:30:39
    Author     : danielvega
--%>
...
<link href="default.css" rel="stylesheet" type="text/css" media="screen" />
	...
	<div id="header">
		<div id="menu">
			<ul id="main">
				<li class="current_page_item"><a href="crearadmin.jsp">Crear Adminsitrador</a></li>
				<li><a href="#">Eliminar</a></li>
				<li><a href="#">Modificar</a></li>
                                <li><a href="veradmin.jsp">Ver administradores</a></li>
                                 <li><a href="Asignarbuses.jsp">Asignar buses</a></li>
                                 <li class="current_page_item"><a href="CrearESTclave.jsp">Crear estacion clave</a></li>
